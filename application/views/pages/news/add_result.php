...
<body class="text-center">
    <div class="form-signin">
        ...
        <?php if ($stat == 'succes') { ?>
            <a id="btn_result" href="<?=site_url('home/news')?>" class="btn btn-secondary"> OK </a>
        <?php } else { ?>
            <div class="btn-group btn-group-toggle">
                <a id="btn_result" href="<?=site_url('home/news')?>" class="btn btn-secondary"> ОК </a>
                <a id="btn_result" href="<?=site_url('admin/add_news')?>" class="btn btn-secondary btn-info">Добавить новость</a>
            </div>
        <?php } ?>
